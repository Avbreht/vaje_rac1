...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0NiwidXNlciI6MjcwMn0:1oshHm:W_E8sSiQa41gNINWfDhyK1HhP80je6e0i-vpUDi4jQM'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v = preuredi_parnost(v)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0NywidXNlciI6MjcwMn0:1oshHm:Sr3UgEg1_bHJjHBQ53B8gM0ARj1sIXmA3sla4H0fhos'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1])",
                  "v = obrni_na_mestu(v)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0OCwidXNlciI6MjcwMn0:1oshHm:GGdDxMhrOXPokh2m1DPsaXwuzlzqAzHXaKQjqliOJhQ'
        try:
