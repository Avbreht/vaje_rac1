...
class Vektor(Vektor):  # type: ignore
...
class Vektor(Vektor):
    ...
    def __truediv__(self, skalar):
        return Vektor(self.x * (1/skalar), self.y * (1/skalar))
...
class Vektor(Vektor):
    ...
    def sta_pravokotna(self, other):
        if self.skalarni_produkt(other) == 0:
            return True
        else:
            return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzNCwidXNlciI6MjcwMn0:1oiX4b:9I1TXyYZK2XCS21TUmC9HAiZJI0'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzNSwidXNlciI6MjcwMn0:1oiX4b:_h-LaXdhVsxE2OpE6FIDO9RZLZQ'
        try:
            tests = [
                    ('str(Vektor(3, 2))', '(3, 2)'),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzNiwidXNlciI6MjcwMn0:1oiX4b:9XdtzyZ2WbV6uGKA2Vm3tZ55Qh4'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzNywidXNlciI6MjcwMn0:1oiX4b:Ch_AsROnvE7vDtN5y79ZFmKqCFY'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzOCwidXNlciI6MjcwMn0:1oiX4b:YxEYMS7ai-6-iu68tc_IttfVJYA'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzOSwidXNlciI6MjcwMn0:1oiX4b:W2Q1nvggWB-HTjGnUWofp617Ufg'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk0MCwidXNlciI6MjcwMn0:1oiX4b:Y3SG8doBQvbqzm5J7bbsBUxUO9E'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk0MSwidXNlciI6MjcwMn0:1oiX4b:sEfHOiux9feh_n1Ir5b6jmAeFxc'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk0MiwidXNlciI6MjcwMn0:1oiX4b:XXQaWt4h8uPNlmfZUPp6PI9UKrg'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk0MywidXNlciI6MjcwMn0:1oiX4b:yKRiPRrl4a7xQAj5ZXwNkcsWtu4'
        try:
            tests = [
