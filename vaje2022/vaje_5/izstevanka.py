...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0OSwidXNlciI6MjcwMn0:1oshHo:Bmj7p-BaO--lN-oyfKubU5sSiihpk3U-5OaPWEiSnYA'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg1MCwidXNlciI6MjcwMn0:1oshHo:xHcxc2bN44ypsgp3uoF7p_5hI49ULNhB6k9gNypnl_E'
        try:
            test_data = [
                ("zgodovina_izstevanja(['Mojca', 'Janez', 'Micka', 'Peter', 'Matjaž', 'Jožefa'], 5)",
                 ['Matjaž', 'Peter', 'Jožefa', 'Janez', 'Micka', 'Mojca']),      
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg1MSwidXNlciI6MjcwMn0:1oshHo:JFLllRRFIdt4z_w_cfrmbSBXqMClVoEi3TeWxpj1P8A'
        try:
            test_data = [
                (["v = odhajanje_iz_kroga(['Mojca', 'Janez', 'Micka', 'Peter', 'Matjaž', 'Jožefa'], 5)",
                  "l = vrni_seznam(v)"],
