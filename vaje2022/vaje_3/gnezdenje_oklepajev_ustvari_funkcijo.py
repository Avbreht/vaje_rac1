...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA2NywidXNlciI6MjcwMn0:1onz0y:PleDZOAAQtX7q8YanvBfLc4KND4'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA2OCwidXNlciI6MjcwMn0:1onz0y:N_wgGTIKR7z82wG2XTEYXc3x_2I'
        try:
            test_data = [
                ("max_globina('burek')", 0),
