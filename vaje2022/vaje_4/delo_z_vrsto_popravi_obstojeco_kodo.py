...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA5MCwidXNlciI6MjcwMn0:1oqBmz:ur_6tAceoWtht6gvd2xSVX05eXs'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA5MSwidXNlciI6MjcwMn0:1oqBmz:wJi-2yWPvU9lL9e-GhQri0Rhyqw'
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA5MiwidXNlciI6MjcwMn0:1oqBmz:vWTlHDN3OwRHO1SSLHLr2ScYwds'
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "odstrani_ntega(v, 3)",
                       "potem1 = str(v)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA5MywidXNlciI6MjcwMn0:1oqBmz:EhTGvYYQl8MoYhHYz7jvCZeYBJE'
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "odstrani_pogojno(v, lambda x: x % 2 == 0)",
                       "potem = str(v)"],
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA5NCwidXNlciI6MjcwMn0:1oqBmz:LhA1I7Y2mBBeFzttlzkXBcj1RD0'
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "obrni(v)",
                       "potem = str(v)"],
