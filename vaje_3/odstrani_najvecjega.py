...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTEzNH0:1mdTLY:DpoIZqj8vqNfjfyuERpqODVtU2c'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTEzNX0:1mdTLY:WO0O_0MM4l5FjDxQ2ai7XbAdtQ4'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTEzNn0:1mdTLY:XAQ-mm8qnuHI-9M5RkZKCMsCSEE'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
