...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5N30:1miIdm:X8-ChJ99w3DcEapoSbDSV5vm1AM'
        try:
            Check.run([
                's = VerizniSeznam()',
                'niz = str(s)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5OH0:1miIdm:ArObe--D4a6EvAINXmOH-Vhkv2w'
        try:
            Check.run([
                's = VerizniSeznam()',
                's.vstavi_na_zacetek(10)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5OX0:1miIdm:RNOsCip_q5J-wUgfjdG2yfho1J4'
        try:
            Check.run([
                's = VerizniSeznam()',
                's.vstavi_na_zacetek(10)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwMH0:1miIdm:NHeZqi94jQYQLhAi1aRLWPxrX48'
        try:
            Check.run([
                's = VerizniSeznam()',
                'niz = str(s)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwMX0:1miIdm:ajJ945ZT_Vnd9GBozpSptEWZTCc'
        try:
            Check.run([
                's = VerizniSeznam()',
                's.vstavi_na_zacetek(10)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwMn0:1miIdm:4Ov-i4CPSYXujbxASymDKM3-IhQ'
        try:
            Check.run([
                's = VerizniSeznam()',
                's.vstavi_na_konec(10)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwM30:1miIdm:fZhBnOwa1IzRtv2bjPyj7JTtTbI'
        try:
            Check.run([
                's = VerizniSeznam()',
