...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzMSwidXNlciI6MjcwMn0:1oshHe:1R-J_VuWq9njszjZ4-Kaga70EAo-aFGzvQKsZ1X6RWQ'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzMiwidXNlciI6MjcwMn0:1oshHe:8IlKVY_lkLTbThbxcqSJg0fVEv7cGXQfzIBphB65y74'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v1, v2 = sodi_in_lihi(v)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzMywidXNlciI6MjcwMn0:1oshHe:MFdrhqIHc7JHxXaaF4MbnKujM6sZe7HxvX4YRZyXLXM'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzNCwidXNlciI6MjcwMn0:1oshHe:dyBsnXsBlVWB0fbUB2J-gCRAsvixWUuKwT3MJ0NCpvc'
        try:
            test_data = [
                (["v1 = iz_seznama([1, 2, 3])",
                  "v2 = iz_seznama([4, 5, 6])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzNSwidXNlciI6MjcwMn0:1oshHe:9FMM5SxWevZ0IsXb8W3N3YEXgqsQcF6splEDU7C64r8'
        try:
            test_data = [
                (["v1 = iz_seznama([7, 5, 2])",
                  "v2 = iz_seznama([1, 3, 4, 9, 8])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzNiwidXNlciI6MjcwMn0:1oshHe:q6WgI25w7caObQ8-pUMmLGKxZT4dzaKUDLTOFTPv8yA'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v1, v2 = odpni_zadrgo(v)",
