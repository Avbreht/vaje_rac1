...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0MSwidXNlciI6MjcwMn0:1oshHb:fVOByZc2KivWgzqtTokhEMGEjWUjDwm8tAYG49vdObY'
        try:
            test_data = [
                (["n = dolzina(None)"],
                 {'n': 0}),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0MiwidXNlciI6MjcwMn0:1oshHb:Nsa43t1Iak0U9z7Q8iz1WTqkMEe-pgdyPCtxImlsvv4'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0MywidXNlciI6MjcwMn0:1oshHb:hNvde6WvLYQPU_MyvciPZ8iBVpZW--4s6qL8wQgHCCc'
        try:
            test_data = [
                ('seznam_sodih(None)', []),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0NCwidXNlciI6MjcwMn0:1oshHb:YR8n85SfWJUyxhpYv3MS1ppnH4hYwA2WWJ_EAZmIRoA'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0NSwidXNlciI6MjcwMn0:1oshHb:3K3GS6tMm9zIz1xda6Jf1Tb6xWBZiPdkBS_YbdGGKlA'
        try:
            test_data = [
