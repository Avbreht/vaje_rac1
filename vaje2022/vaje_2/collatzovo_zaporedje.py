...
def najvecji_clen(n):
    if n == 1 or n == 2:
        return n
    m = n
    for i in range(dolzina_zaporedja(n)):
        if m < naslednji_clen(n):
            m = naslednji_clen(n)
        n = naslednji_clen(n)
    return m
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAyMywidXNlciI6MjcwMn0:1ol4qq:m2Am41EyO6HPn664MdevVObMxIo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAyNCwidXNlciI6MjcwMn0:1ol4qq:_dFse42RkETTjdWVe2I1HprUHe8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAyNSwidXNlciI6MjcwMn0:1ol4qq:Y1r_HzF518rQEY55M4nCcdAbpbI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAyNiwidXNlciI6MjcwMn0:1ol4qq:m-PUkd_Gb1ZISRudfW3ps2PMYBU'
        try:
