...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4MiwidXNlciI6MjcwMn0:1oiu49:L17SRuzp8A_ASwUnPlNQalvIDhk'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4MywidXNlciI6MjcwMn0:1oiu49:kApbkU8EfJLHmKbhKsI5kWW0el4'
        try:
            test_data = [
                ("""Vektor({}).elementi""", {}),
                ("""len(Vektor({}))""", 0),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4NCwidXNlciI6MjcwMn0:1oiu49:penyv1seTNgbWQzaHiEX0QryLbI'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4NSwidXNlciI6MjcwMn0:1oiu49:zxAi5qr-OIsREVnhxuVo9PN9cFc'
        try:
            test_data = [
