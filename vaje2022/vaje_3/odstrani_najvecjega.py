...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA2NCwidXNlciI6MjcwMn0:1oncTm:kEi01BtXmAHY_YhySQ5ZfA8A_GA'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA2NSwidXNlciI6MjcwMn0:1oncTm:Z86BikEOkSAIXdlDMDgfnVlC2mM'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjA2NiwidXNlciI6MjcwMn0:1oncTm:HK2KovSqlMj5MAc2V2w5tJjOHdw'
        try:
            test_data = [
                (['s = Sklad()',
                  'for i in range(10):',
