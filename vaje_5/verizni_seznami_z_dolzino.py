...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwNH0:1miIdr:oi0sNgvYSrsvtaN4HiB3x3WWFVg'
        try:
            tests = [
                (['s = VerizniSeznam()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwNX0:1miIdr:58UUxGdKy7z0Ilfpu3sGYFndSTc'
        try:
            tests = [
                (['s = VerizniSeznam()',
                  's.vstavi_na_zacetek(10)',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwNn0:1miIdr:CRil4zOxSc_R5ZnmFNOfs68di9A'
        try:
            tests = [
                (['s1 = VerizniSeznam()',
                  's2 = VerizniSeznam()',
