...
# print(izmeri_cas(f1a, 30),izmeri_cas(f1a, 50))
# print(izmeri_cas(f1b, 30),izmeri_cas(f1b, 50))
# print(izmeri_cas(f1c, 30),izmeri_cas(f1c, 50))
# print(izmeri_cas(f1d, 30),izmeri_cas(f1d, 50))
# print(izmeri_cas(f1e, 30),izmeri_cas(f1e, 50))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIzMn0:1mnfU8:aeEg1eiuTNgNGouV9BpAKJ_-qGo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIzM30:1mnfU8:EnEFrq-_4Ftkar6-s9KpAGeYmJw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIzNH0:1mnfU8:QgGPnpB52oNZr4H3PbS_0OVtN7g'
        try:
