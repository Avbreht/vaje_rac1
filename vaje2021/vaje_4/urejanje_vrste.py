...
def uredi_z_zlivanjem(v):
    v1 = Vrsta()
    v2 = Vrsta()
    pomozna = Vrsta()
    x = prestej_elemente(v)
    for i in range(x):
        if i < (x // 2):
            v1.vstavi(v.zacetek())
    ...
    while not pomozna.prazna():
        ...
        pomozna.odstrani()
    while not v1.prazna():
        if v1.zacetek() < v2.zacetek():
            pomozna.vstavi(v1.zacetek())
            v1.odstrani()
        else:
            pomozna.vstavi(v2.zacetek())
            v2.odstrani()
    if x % 2 == 1:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE2OX0:1mg2ys:iOT9IbLFDtx5W6krjlE_Rz200DI'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE3MH0:1mg2ys:oouVPymSvRpM0Q1RejpFnmqwnLU'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE3MX0:1mg2ys:M-NqtORPFFIIreQvqXlWwmYVUus'
        try:
            test_data = [
