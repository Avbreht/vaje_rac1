...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTEzN30:1mdU0s:U_8euljAWL32_jXj04LfJwKmlEQ'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTEzOH0:1mdU0s:ODigTG73SeuLDC83YsCRFrQ4iHo'
        try:
            test_data = [
                ("max_globina('burek')", 0),
