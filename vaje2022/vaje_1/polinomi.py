...
# =============================================================================
    ...
    def __eq__(self, other) -> bool:
        for i in self._koef:
            if i == 0:
                self._koef.remove(i)
        for i in other._koef:
            if i == 0:
                other._koef.remove(i)
        if self._koef == other._koef:
            return True
        else:
            return False
...
# =============================================================================
    ...
    def __add__(self, other):
        x = max(len(self._koef), len(other._koef))
        tab = []
        if len(self._koef) < len(other._koef):
            for i in range(len(self._koef)):
                tab.append(self._koef[i] + other._koef[i])
            tab += other._koef[:len(self._koef)]
        elif len(self._koef) > len(other._koef):
            for i in range(len(other._koef)):
                tab.append(other._koef[i] + self._koef[i])
            tab += self._koef[:len(other._koef)]
        return Polinom(tab)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4NiwidXNlciI6MjcwMn0:1oiu4D:rZBxpzVQTGChuQ_DmUqe0Kw4lWU'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4NywidXNlciI6MjcwMn0:1oiu4D:sHN4cig8vegNERUDFFi6z9U44YU'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4OCwidXNlciI6MjcwMn0:1oiu4D:gF_WswFUYAKS3UBdcNkCBau3HcI'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk4OSwidXNlciI6MjcwMn0:1oiu4D:IDkppC-iEamxhai21XB0ElAe9hA'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5MCwidXNlciI6MjcwMn0:1oiu4D:gn_7ZtSMmTphQYYV6PYA190kGnM'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5MSwidXNlciI6MjcwMn0:1oiu4D:VBcgNebODDzc2Sv8lrNRjdmLBAM'
        try:
            tests = [
