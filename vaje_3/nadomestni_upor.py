...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE0Mn0:1mdU14:50xmcLyHXAO_6kXAR-JRpeOZY8U'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE0M30:1mdU14:rvlPrTAfLfM9UZraszplWu2vZWQ'
        try:
            test_data = [
                ("upor_vezja('3 5 Z')", 8),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE0NH0:1mdU14:ifJJ0PEEooYbORueNv4VjW3U3Dk'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE0NX0:1mdU14:R019xx2I86_0gu6FIIwpa0grCW4'
        try:
            test_data = [
                ("stari_macki('3 5 Z')", 8),
