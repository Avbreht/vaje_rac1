...
pokvarjena_tocka = SlabaPolarnaTocka(5, 2)
pokvarjena_tocka.r -= 7
# =====================================================================@031970=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2OCwidXNlciI6MjcwMn0:1oiYUd:qNjWgpMB8-Wl0xAK_fTxLWuaQyQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2OSwidXNlciI6MjcwMn0:1oiYUd:9wyukTIVtXaNDR8xmARQmOsR9cQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk3MCwidXNlciI6MjcwMn0:1oiYUd:NQoZP-MQYatHpX58quweWtrmcTo'
        try:
            test_data = [
                (['a = BoljsaPolarnaTocka(-10, 0)',
                  'r0 = a.vrednost_r()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk3MSwidXNlciI6MjcwMn0:1oiYUd:crXZUxEm7z2qZDVAWEKn9MaD060'
        try:
