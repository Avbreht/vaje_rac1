...
class Zajec:
    ...
    @starost.setter
    def starost(self, starost):
        self._starost = max(0, starost)

    def __init__(self, teza, starost) -> None:
        self.teza = teza
...
def uredi(teze, starosti):
    ...
    for i in range(len(teze)):
        tab.append(Zajec(teza=teze[i], starost=starosti[i]))
    tab.sort()
    return tab
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5NiwidXNlciI6MjcwMn0:1ol4oe:6ZS6nb02tDmgmHlS8sjzPI2VGWA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5NywidXNlciI6MjcwMn0:1ol4oe:wQIrXR59zWQ7zv-R-AO-3605WRM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5OCwidXNlciI6MjcwMn0:1ol4oe:8hzEH5vM6GfQ2fa_GrXPS51aGsI'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk5OSwidXNlciI6MjcwMn0:1ol4oe:o-ZxnvGbk79G3wSxwXWm0KbDp9o'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAwMCwidXNlciI6MjcwMn0:1ol4oe:0_1NrVy7yaiHil0kzPJD47d7ap0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAwMSwidXNlciI6MjcwMn0:1ol4oe:xvXVh-HxAdULOTTMCvjjKoIICWY'
        try:
