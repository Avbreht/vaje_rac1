...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzNywidXNlciI6MjcwMn0:1oshHi:-bcZYjSsftlDBH2UxB9ymyzcDX8HJaXjJw1GSBIBsFk'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzOCwidXNlciI6MjcwMn0:1oshHi:ECm1_DEgu7ykITwsP32SY-BabIqnUMq9vJx98q1_Nb8'
        try:
            test_data = [
                (["v = iz_seznama([1, 2, 4, 7, 8])",
                  "v = vstavi_v_urejenega(v, 3)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjgzOSwidXNlciI6MjcwMn0:1oshHi:zOzIOrqdwSZJh3ChG-aLkSVvjmGfLtQFUZObLbLR3Ew'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 5, 3, 5])",
                  "v = odstrani(v, 5)",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjg0MCwidXNlciI6MjcwMn0:1oshHi:_LDQxRnDEye-FhZgqe_GEEo_lH3ymzDWgmjLmHnBr00'
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2])",
                  "v = multipliciraj_verigo(v, 3)",
