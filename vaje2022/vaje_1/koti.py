...
class Kot:
    ...
    def __init__(self, st, m, sek) -> None:
        self.sekunde = sek % 60
        self.minute = (m + sek // 60)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk1NywidXNlciI6MjcwMn0:1oiX4l:oFI-Ldi9TA5PklkbNJ9vNnLgvXs'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk1OCwidXNlciI6MjcwMn0:1oiX4l:5BarwfnqpmMsy04iOVus36SSQt4'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk1OSwidXNlciI6MjcwMn0:1oiX4l:dK06guzfsjjq9DVJV6oHOTUQZYc'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2MCwidXNlciI6MjcwMn0:1oiX4l:hXoGnmSC3Q1wecxGpRrAVBLvcbo'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2MSwidXNlciI6MjcwMn0:1oiX4l:oTg5Yg819f8eqvwXqTxqLcdcncQ'
        try:
            testi = [
                ('Kot(15, 65, 100) == Kot(10, 20, 30)', False),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2MiwidXNlciI6MjcwMn0:1oiX4l:5ylIdkZzBPiaWjvWnErhWe4baUI'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2MywidXNlciI6MjcwMn0:1oiX4l:wmo8iecDzLb-H0ML5OUUy9ME0lU'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2NCwidXNlciI6MjcwMn0:1oiX4l:gafsEw4CPQnDSpvhOPzsAjqMCFI'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2NSwidXNlciI6MjcwMn0:1oiX4l:GRL9BtvPG3udhPoSeLNloHY76JA'
        try:
            testi = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2NiwidXNlciI6MjcwMn0:1oiX4l:bcF5ZpSLSWRXokNJXLXfG0pxHIE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTk2NywidXNlciI6MjcwMn0:1oiX4l:gKcvzFtiZOhT0wJ3YO9uIqdO0XI'
        try:
            testi = [
