...
class TestniRazred(TestniRazred):
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzMiwidXNlciI6MjcwMn0:1oiX4Y:rlQymHBFwfTveXSSySpm8hKOIt4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMTkzMywidXNlciI6MjcwMn0:1oiX4Y:Rk_x6vgTB9rdYGk1xR32nxMC1iM'
        try:
            Check.equal('TestniRazred().vrednost', 123)
