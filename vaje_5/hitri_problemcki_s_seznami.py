...
# =====================================================================@029209=
# 3. podnaloga
# Napišite funkcijo `razdrobi_glede_na_enice(vs)`, ki razdrobi verižni seznam
...
# ki imajo natanko `i` enic. Vrstni red elementov v verižnih seznamih `t[i]`
...
#     >>> [str(s) for s in razdrobi_glede_na_enice(vs)]
#     ['0 -> •', '210 -> 10 -> •', '•', '11210 -> •']
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwN30:1miIdv:2bCm3e3eeHNsyMLylWsI8esEzV0'
        try:
            tests = [
                (['s = VerizniSeznam()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwOH0:1miIdv:31KMMTu4TBXdy9xb5jHmXnMI7Qw'
        try:
            tests = [
                (['s = VerizniSeznam()',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTIwOX0:1miIdv:eeOVS2O1MzC9yLWo_JD_BTrIbg0'
        try:
            tests = [
                (['vs = VerizniSeznam()',
                  'vs.vstavi_na_zacetek(0)',
                  ...
                  'vs.vstavi_na_zacetek(11210)',
                  'n = str(vs)',
                  'r = [str(s) for s in razdrobi_glede_na_enice(vs)]'],
                 {'r': ['0 -> •', '210 -> 10 -> •', '•', '11210 -> •']}),
            ]
