...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5Mn0:1miIdi:c4rHXWS6RRLAOCfx9v7zienpJL4'
        try:
            test_data = [
                (["n = dolzina(None)"],
                 {'n': 0}),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5M30:1miIdi:egwXmeP63vlTNaZEIqjmpksVTRQ'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5NH0:1miIdi:t4NQtiXW5DLJb4IarhYy-X_yYPk'
        try:
            test_data = [
                ('seznam_sodih(None)', []),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5NX0:1miIdi:rsXY81mzanp9izWqqES-cJV9zI4'
        try:
            test_data = [
                (["v = iz_seznama(['sreda', 'četrtek', 'petek', 'sobota'])",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjoyNzAyLCJwYXJ0IjoyOTE5Nn0:1miIdi:G25AT-YCaNV1rVXWN4Mej7L_whU'
        try:
            test_data = [
