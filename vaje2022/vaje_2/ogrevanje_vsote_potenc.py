...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAxNiwidXNlciI6MjcwMn0:1ol4p0:8bjKcwiyGphjlHiCo8mjUTiJBLk'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAxNywidXNlciI6MjcwMn0:1ol4p0:JAXaqcPdvWw3X4LUHqfx8fiUuME'
        try:
            resitev = Check.current_part['solution']
            if resitev.count('for') > 0 or resitev.count('while') > 0:
                Check.feedback("Nalogo rešite s pomočjo rekurzije in ne z zankami.")
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMjAxOCwidXNlciI6MjcwMn0:1ol4p0:18HW1MbCQCMcgtQLOQspIGJYbgY'
        try:
            resitev = Check.current_part['solution']
            if resitev.count('for') > 0 or resitev.count('while') > 0:
                Check.feedback("Nalogo rešite s pomočjo rekurzije in ne z zankami.")
